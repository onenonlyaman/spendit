...
export const SimulatorView: React.FC = () => {
 ...
 "What-If" Scenario Sandbox
          ...
          <p className="text-xs text-secondary max-w-xl mt-1">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 pt-2">
          <div className="p-4 rounded-2xl bg-black/[0.02] dark:bg-white/[0.04] border border-black/[0.04] dark:border-white/[0.06]">
            <span className="text-xs text-secondary block">Monthly Capital Boost</span>
          ...
          <div className="p-4 rounded-2xl bg-black/[0.02] dark:bg-white/[0.04] border border-black/[0.04] dark:border-white/[0.06]">
            <span className="text-xs text-secondary block">1-Year Accumulated Alpha</span>
            <span className="font-mono font-bold text-xl sm:text-2xl text-accent block mt-0.5">
              +{formatCurrency(oneYearAdditionalWealth, currencySymbol, privacyMode)}
            </span>
          </div>

          <div className="p-4 rounded-2xl bg-black/[0.02] dark:bg-white/[0.04] border border-black/[0.04] dark:border-white/[0.06]">
            <span className="text-xs text-secondary block">3-Year Compounding Horizon</span>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-5">
                ...
                <button
                  ...
                  className={`text-xs font-mono px-2 py-0.5 rounded-full border transition-colors ${
                    expenseReduction === amt
                      ...
                      : 'bg-black/5 dark:bg-white/10 border-black/5 dark:border-white/5 text-secondary hover:bg-black/10'
                  }`}
                >
                  +{currencySymbol}{amt}
                </button>
                ...
                <button
                  ...
                  className={`text-xs font-mono px-2 py-0.5 rounded-full border transition-colors ${
                    additionalIncome === amt
                      ? 'bg-accent text-white border-apple-blue font-bold'
                      : 'bg-black/5 dark:bg-white/10 border-black/5 dark:border-white/5 text-secondary hover:bg-black/10'
                  }`}
                >
                  +{currencySymbol}{amt}
        ...
        <div className="lg:col-span-2 space-y-5">
          ...
          {selectedGoal ? (
              ...
              <div className="p-4 rounded-2xl bg-black/[0.02] dark:bg-white/[0.04] border border-black/[0.04] dark:border-white/[0.06] space-y-3">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                  <div className="p-3 rounded-xl bg-black/5 dark:bg-white/10">
                    <span className="text-xs text-secondary block uppercase">Standard Pace</span>
                  ...
                  <div className="p-3 rounded-xl bg-apple-green/10 border border-apple-green/20">
                    <span className="text-xs font-mono text-apple-green block uppercase font-semibold">Fast-Track Pace</span>
                  ...
                  <div className="p-3 rounded-xl bg-apple-blue/10 border border-apple-blue/20">
                    <span className="text-xs font-mono text-accent block uppercase font-semibold">Time Saved</span>
                    <span className="font-mono font-bold text-base text-accent block mt-0.5">
            ...
            <div className="apple-inset-group p-6 text-center text-xs text-secondary">
            ...
            <div className="space-y-3">
              <div>
                <div className="flex justify-between text-xs font-mono mb-1">
                  <span className="text-secondary">Year 1 (+{formatCurrency(oneYearAdditionalWealth, currencySymbol)}):</span>
              ...
              <div>
                <div className="flex justify-between text-xs font-mono mb-1">
                  <span className="text-secondary">Year 2 (+{formatCurrency(oneYearAdditionalWealth * 2, currencySymbol)}):</span>
                  <span className="font-bold text-accent">{formatCurrency(oneYearAdditionalWealth * 2, currencySymbol)}</span>
                </div>
                <div className="h-2.5 w-full rounded-full bg-black/5 dark:bg-white/10 overflow-hidden">
                  <div className="h-full rounded-full bg-accent" style={{ width: '66.6%' }} />
                </div>
              </div>

              <div>
                <div className="flex justify-between text-xs font-mono mb-1">
                  <span className="text-secondary">Year 3 Compounded Total (+{formatCurrency(threeYearAdditionalWealth, currencySymbol)}):</span>
