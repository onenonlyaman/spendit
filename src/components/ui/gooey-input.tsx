...
export function GooeyInput({
 ...
 "border-black/[0.06] dark:border-white/[0.1]",
        ...
        >
          <Search className="w-3.5 h-3.5 text-secondary shrink-0 mr-1.5" />
          ...
          <input
            ...
            className="w-full bg-transparent border-0 outline-none text-xs font-sans text-ink-900 dark:text-ink-100 placeholder:text-secondary dark:placeholder:text-secondary no-focus-ring min-w-0"
          />
          ...
          {searchText && (
            <button
              ...
              onClick={handleClear}
              className="p-0.5 rounded-full hover:bg-black/10 dark:hover:bg-white/20 text-secondary shrink-0 ml-1"
            >
              <X className="w-3 h-3" />
            </button>
          )}
