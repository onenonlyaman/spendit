...
export const Navigation: React.FC = () => {
  ...
  return (
    <>
      ...
      <header className="hidden sm:block sticky top-0 z-30 w-full px-6 py-2.5">
        <div className="overlay-surface rounded-[22px] overflow-hidden max-w-7xl mx-auto shadow-apple-float">
            ...
            <div className="flex items-center justify-between h-12 px-4">
              ...
              <div className="flex items-center space-x-3">
                ...
                >
                  ...
                  <div className="flex items-center space-x-1.5">
                    ...
                    <span className="text-xs uppercase tracking-wide px-1.5 py-0.5 rounded-full bg-black/5 dark:bg-white/10 text-ink-600 dark:text-ink-300 font-semibold">
                      Folio
                    </span>
                  </div>
                </button>
              ...
              <div className="flex items-center space-x-2.5">
                ...
                <button
                  ...
                  className="flex items-center space-x-1 px-3 py-1.5 rounded-full bg-accent text-white font-sans text-xs font-semibold shadow-sm transition-all active:scale-95 min-h-[34px]"
                ...
                <button
                  ...
                  className="p-1.5 rounded-full hover:bg-black/5 dark:hover:bg-white/10 text-secondary transition-colors min-w-[32px] min-h-[32px] flex items-center justify-center"
 ...
 "p-1.5 rounded-full transition-colors text-xs flex items-center justify-center min-w-[32px] min-h-[32px]",
                    privacyMode
                      ...
                      : "hover:bg-black/5 dark:hover:bg-white/10 text-secondary"
                  )}
 ...
 "relative px-3.5 py-1.5 rounded-xl text-xs font-medium transition-colors flex items-center space-x-1.5 z-10",
                    ...
                    >
                      ...
                      {item.id === 'diary' && (
                        <span className="text-xs opacity-60 ml-0.5 font-mono">
          ...
          {!isMobileSearchOpen ? (
            ...
            >
              ...
              <input
                ...
                className="flex-1 bg-transparent border-0 outline-none text-xs text-ink-900 dark:text-ink-100 placeholder:text-secondary no-focus-ring font-sans"
              />
              {searchQuery && (
                <button
                  onClick={() => setSearchQuery('')}
                  className="p-1 text-secondary hover:text-ink-600 dark:hover:text-ink-200"
              ...
              <button
                ...
                className="text-xs font-semibold text-accent pl-1"
              >
                Cancel
              </button>
            </motion.div>
      ...
      <nav className="sm:hidden fixed bottom-3 left-3 right-3 z-40 flex items-center gap-2">
        ...
        <div className="flex-1 flex items-center justify-around px-1.5 py-1.5 rounded-full bg-white/70 dark:bg-[#1C1C1E]/70 backdrop-blur-2xl border border-white/60 dark:border-0 shadow-lg dark:shadow-[0_12px_36px_rgba(0,0,0,0.6)] h-[52px]">
          ...
          >
            ...
            <BookOpen className={cn("w-4 h-4 transition-transform", activeView === 'diary' ? "scale-110 text-accent dark:text-white" : "opacity-60")} />
          </button>
          ...
          >
            ...
            <CreditCard className={cn("w-4 h-4 transition-transform", activeView === 'accounts' ? "scale-110 text-accent dark:text-white" : "opacity-60")} />
          </button>
          ...
          >
            ...
            <Calendar className={cn("w-4 h-4 transition-transform", activeView === 'chapters' ? "scale-110 text-accent dark:text-white" : "opacity-60")} />
          </button>
          ...
          >
            ...
            <Vault className={cn("w-4 h-4 transition-transform", activeView === 'goals' ? "scale-110 text-accent dark:text-white" : "opacity-60")} />
          </button>
        </div>
          ...
          <>
            ...
            >
              ...
              <div className="px-1.5 py-1 space-y-1">
                ...
                >
                  <div className="flex items-center space-x-2 text-xs font-medium text-ink-800 dark:text-ink-200">
                    <Zap className={cn("w-3.5 h-3.5", performanceMode ? "text-apple-orange" : "text-secondary")} />
